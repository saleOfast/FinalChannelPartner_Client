            ...
            <div className="group-wrapper">
              <div className="group-28 d-flex flex-column gap-2">
                ...
                <div className="order-date-amount">
                  ...
                  <button type="button" className="btn btn_red d-flex align-items-center gap-1 m-auto"><i className="fa-solid fa-rotate-right" /> Pending</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="group-wrapper">
              <div className="group-28 d-flex flex-column gap-2">
                ...
                <div className="order-date-amount">
                  ...
                  <div className="underline" />
                  <button type="button" className="btn btn_green d-flex align-items-center gap-1 m-auto"><i className="fa-solid fa-check" />Delivered</button>
                </div>
              </div>
            </div>
          </div>
