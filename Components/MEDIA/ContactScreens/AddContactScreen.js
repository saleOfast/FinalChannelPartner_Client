...
const AddContactScreen = () => {
    ...
    async function getAccountsList() {
        await fetchData(`/db/account?platform_id=5`, setAccountsList, errorToast, setErrorToast)
    }
                                ...
                                <button
                                    ...
                                    <div className="text-end">
                                        <div className="submit_btn">
                                            ...
                                            {viewMode ? null : <>
                                                <Link href='/media/Contacts'><button className="btn btn-cancel m-3 ">Cancel</button></Link>
                                                {editMode ? (
                                    ...
                                    <ul className="tasks_list">
                                        {userInfo?.db_leads?.reduce((acc, lead) => {
                                            ...
                                            <li key={i} className="list-item">
                                                <div className="opp_box">
                                                    <Link href={`/media/AddAccount?id=${account.acc_id}&vw=mds`}>
                                ...
                                <div className="tasks_details">
                                    <ul className="tasks_list">
                                        {userInfo?.db_leads?.reduce((acc, lead) => {
                                            ...
                                            <li key={i} className="list-item">
                                                <div className="opp_box">
                                                    <Link href={`/media/OpportunityView?id=${opportunity.opp_id}`}>
