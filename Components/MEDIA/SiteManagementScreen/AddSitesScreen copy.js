...
const AddSitesScreen = () => {
  ...
  const submitHandler = async () => {
    if (hasCookie("token")) {
      ...
      oppBody.media_owner = loginDetails.user_id;
      try {
        ...
        <div className="bread_head">
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item fw-bolder">
                <Link href="/media/ManageLeads"> Manage Sites </Link>
              </li>
                ...
                <div className="add_screen_head">
                  ...
                  <div className="add_user_form">
                    <div className="row">
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        ...
                        >
                          <label htmlFor="task_name">Site Category</label>
                          <Select
                            id={userInfo.site_category}
                            isDisabled={viewMode}
                            defaultValue={""}
                            options={[
                            ...
                            value={[
                              ...
                              (option) =>
                                option.value === userInfo.site_category
                            )}
                            onChange={(e) => {
                              setUserInfo({
                                ...userInfo,
                                site_category: e.value,
                              });
                              setErrorData({ ...errorData, site_category: "" });
                            }}
                          />
                          <span className="errorText">
                            {errorData?.site_category
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        ...
                        >
                          <label htmlFor="task_name">Media Format</label>
                          <Select
                            id={userInfo.site_category}
                            isDisabled={viewMode}
                            defaultValue={""}
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        ...
                        >
                          <label htmlFor="task_name">Media Vehicle</label>
                          <Select
                            id={userInfo.site_category}
                            isDisabled={viewMode}
                            defaultValue={""}
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        ...
                        >
                          <label htmlFor="task_name">Media Type</label>
                          <Select
                            id={userInfo.site_category}
                            isDisabled={viewMode}
                            defaultValue={""}
                        ...
                        >
                          ...
                          <Select
                            ...
                            value={[
                              ...
                              (option) => option.value === userInfo.site_status
                            )}
                            onChange={(e) => {
                              setUserInfo({
                                ...userInfo,
                              ...
                              setErrorData({ ...errorData, site_status: "" });
                            }}
                          />
                          <span className="errorText">
                            {errorData?.site_status
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="location">Traffic From</label>
                          <input
                            type="text"
                            name="Location"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="location">Traffic To</label>
                          <input
                            type="text"
                            name="Location"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="location">Position of Site</label>
                          <input
                            type="text"
                            name="Location"
                        ...
                        >
                          ...
                          <Select
                            ...
                            value={[
                              ...
                              (option) => option.value === userInfo.rating
                            )}
                            onChange={(e) => {
                              setUserInfo({
                                ...userInfo,
                              ...
                              setErrorData({ ...errorData, rating: "" });
                            }}
                          />
                          <span className="errorText">
                            {errorData?.rating ? errorData.rating : ""}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        ...
                        >
                          ...
                          <Select
                            id={userInfo.availability_status}
                            isDisabled={viewMode}
                            defaultValue={""}
                            options={[
                            ...
                            value={[
                              ...
                              (option) =>
                                option.value === userInfo.availability_status
                            )}
                            onChange={(e) => {
                              setUserInfo({
                                ...userInfo,
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="email">Available From </label>
                          <input
                            type="date"
                            name="date"
                            id="date"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="email">Available To </label>
                          <input
                            type="date"
                            name="date"
                            id="date"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="location">Remarks</label>
                          <input
                            type="text"
                            name="Location"
                  ...
                  <div className="add_user_form">
                    <div className="row">
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="email">Lease From </label>
                          <input
                            type="date"
                            name="date"
                            id="date"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          <label htmlFor="email">Lease To </label>
                          <input
                            type="date"
                            name="date"
                            id="date"
                      ...
                      <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                        <div className="input_box">
                          ...
                          <input
                            ...
                            value={
                              userInfo.total_sq_ft ? userInfo.total_sq_ft : ""
                            }
                          />
                        </div>
                      </div>
                        ...
                        <div className="input_box">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setUserInfo({
                                ...userInfo,
                                selling_cost_month: e.target.value,
                              })
                            }
                            value={
                              userInfo.selling_cost_month
                                ? userInfo.selling_cost_month
                                : ""
                            }
                          />
                        ...
                        <div className="input_box">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setUserInfo({
                                ...userInfo,
                                buying_cost_month: e.target.value,
                              })
                            }
                            value={
                              userInfo.buying_cost_month
                                ? userInfo.buying_cost_month
                                : ""
                            }
                          />
                        ...
                        <div className="input_box">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setUserInfo({
                                ...userInfo,
                                leased_cost_month: e.target.value,
                              })
                            }
                            value={
                              userInfo.leased_cost_month
                                ? userInfo.leased_cost_month
                                : ""
                            }
                          />
                        ...
                        <div className="input_box">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setUserInfo({
                                ...userInfo,
                                card_rate_month: e.target.value,
                              })
                            }
                            value={
                              userInfo.card_rate_month
                                ? userInfo.card_rate_month
                                : ""
                            }
                          />
